...
def test_vop_cache_hit_backfills_view_unique_id_from_metadata_when_missing_in_payload(monkeypatch):
    from vop_interwoven.csv_export import view_result_to_vop_row
    ...
    assert row["FromCache"] == "Y"
    assert row["ViewUniqueId"] == "UID-META-123"
