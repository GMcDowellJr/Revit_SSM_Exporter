...
- `_bin_elements_to_tiles` — pipeline.py (L2453)
...
- `_get_ambiguous_tiles` — pipeline.py (L2519)
...
- `_is_supported_2d_view` — pipeline.py (L2339)
...
- `_mark_rect_center_cell` — pipeline.py (L2602)
- `_mark_thin_band_along_long_axis` — pipeline.py (L2610)
...
- `_render_areal_element` — pipeline.py (L2549)
- `_render_proxy_element` — pipeline.py (L2564)
...
- `_should_skip_outside_view_volume` — pipeline.py (L2386)
...
- `_stamp_proxy_edges` — pipeline.py (L2589)
...
- `_tile_has_depth_conflict` — pipeline.py (L2485)
- `_tiles_fully_covered_and_nearer` — pipeline.py (L2422)
...
- `export_view_raster` — pipeline.py (L2630)
