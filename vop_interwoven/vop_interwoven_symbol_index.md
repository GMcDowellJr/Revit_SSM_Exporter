...
- `_bin_elements_to_tiles` — pipeline.py (L3456)
...
- `_compute_cell_metrics_np` — csv_export.py (L239)
- `_compute_cell_metrics_py` — csv_export.py (L311)
...
- `_extract_view_unique_id` — csv_export.py (L540)
...
- `_get_ambiguous_tiles` — pipeline.py (L3522)
...
- `_get_manifest_csv_columns` — csv_export.py (L1292)
...
- `_intersects_crop_volume` — pipeline.py (L3353)
- `_is_excluded_from_extent_expansion` — revit/annotation.py (L12)
- `_is_from_cache` — csv_export.py (L134)
- `_is_importable` — bootstrap.py (L24)
- `_is_supported_2d_view` — pipeline.py (L3300)
...
- `_mark_rect_center_cell` — pipeline.py (L3594)
- `_mark_thin_band_along_long_axis` — pipeline.py (L3602)
...
- `_render_proxy_element` — pipeline.py (L3552)
...
- `_should_skip_outside_view_volume` — pipeline.py (L3379)
...
- `_stamp_proxy_edges` — pipeline.py (L3577)
...
- `_tile_has_depth_conflict` — pipeline.py (L3488)
- `_tiles_fully_covered_and_nearer` — pipeline.py (L3418)
...
- `_viewtype_name_from_value` — csv_export.py (L485)
- `_xyz_tuple` — core/silhouette.py (L429)
- `build_core_csv_row` — csv_export.py (L943)
- `build_occlusion_row` — csv_export.py (L1226)
- `build_vop_csv_row` — csv_export.py (L1001)
...
- `compute_annotation_type_metrics` — csv_export.py (L389)
- `compute_cell_metrics` — csv_export.py (L224)
- `compute_config_hash` — root_cache.py (L300)
- `compute_external_cell_metrics` — csv_export.py (L155)
- `compute_manifest_sha256` — metrics_manifest.py (L144)
- `compute_view_frame_hash` — csv_export.py (L921)
...
- `get_core_csv_header` — csv_export.py (L1661)
...
- `get_occlusion_csv_header` — csv_export.py (L1687)
- `get_perf_csv_header` — csv_export.py (L1761)
...
- `get_vop_csv_header` — csv_export.py (L1672)
...
- `view_result_to_core_row` — csv_export.py (L1779)
- `view_result_to_occlusion_row` — csv_export.py (L1700)
- `view_result_to_perf_row` — csv_export.py (L2217)
- `view_result_to_vop_row` — csv_export.py (L1913)
