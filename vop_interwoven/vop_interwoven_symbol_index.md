...
- streaming.py
  - `run_vop_pipeline_streaming` (L766)
- dynamo_helpers.py
  - `run_pipeline_from_dynamo_input` (L227)
- pipeline.py
  - `process_document_views` (L540)
- streaming.py
  - `process_document_views_streaming` (L549)
- pipeline.py
  - `render_model_front_to_back` (L1933)
- pipeline.py
  - `init_view_raster` (L1628)
- pipeline.py
  - `_view_signature` (L272)
- revit/view_basis.py
...
- `StreamingExporter` — streaming.py (L106)
...
- `_clip_poly_to_rect_uv` — core/raster.py (L2069)
- `_coerce_view_id` — thinrunner_streaming.py (L142)
- `_coerce_view_id_int` — csv_export.py (L458)
...
- `_compute_cell_metrics_np` — csv_export.py (L253)
- `_compute_cell_metrics_py` — csv_export.py (L325)
- `_compute_manifest_metrics_payload` — pipeline.py (L497)
- `_convex_hull_2d` — core/silhouette.py (L3122)
- `_cropbox_fingerprint` — pipeline.py (L227)
...
- `_diagnose_link_geometry_transform` — pipeline.py (L122)
...
- `_extract_view_identity_for_csv` — pipeline.py (L383)
- `_extract_view_summary` — pipeline.py (L1780)
- `_extract_view_unique_id` — csv_export.py (L554)
...
- `_get_ambiguous_tiles` — pipeline.py (L3525)
...
- `_get_manifest_csv_columns` — csv_export.py (L1306)
- `_get_memory_mb` — memory_telemetry.py (L8)
- `_get_metrics_triplet_from_view_result` — csv_export.py (L111)
...
- `_intersects_crop_volume` — pipeline.py (L3356)
- `_is_excluded_from_extent_expansion` — revit/annotation.py (L12)
- `_is_from_cache` — csv_export.py (L148)
- `_is_importable` — bootstrap.py (L24)
- `_is_supported_2d_view` — pipeline.py (L3303)
...
- `_mark_rect_center_cell` — pipeline.py (L3597)
- `_mark_thin_band_along_long_axis` — pipeline.py (L3605)
...
- `_perf_ms` — pipeline.py (L210)
- `_perf_now` — pipeline.py (L205)
...
- `_render_proxy_element` — pipeline.py (L3555)
...
- `_should_skip_outside_view_volume` — pipeline.py (L3382)
...
- `_stamp_proxy_edges` — pipeline.py (L3580)
...
- `_tile_has_depth_conflict` — pipeline.py (L3491)
- `_tiles_fully_covered_and_nearer` — pipeline.py (L3421)
- `_to_host_point` — core/silhouette.py (L1886)
- `_to_sequence` — thinrunner_streaming.py (L41)
...
- `_view_signature` — pipeline.py (L272)
- `_view_type_name` — revit/view_basis.py (L1163)
- `_viewtype_name_from_value` — csv_export.py (L499)
- `_xyz_tuple` — core/silhouette.py (L429)
- `build_core_csv_row` — csv_export.py (L957)
- `build_occlusion_row` — csv_export.py (L1240)
- `build_vop_csv_row` — csv_export.py (L1015)
...
- `compute_annotation_type_metrics` — csv_export.py (L403)
- `compute_cell_metrics` — csv_export.py (L238)
- `compute_config_hash` — root_cache.py (L300)
- `compute_external_cell_metrics` — csv_export.py (L169)
- `compute_manifest_sha256` — metrics_manifest.py (L144)
- `compute_view_frame_hash` — csv_export.py (L935)
...
- `get_core_csv_header` — csv_export.py (L1675)
...
- `get_occlusion_csv_header` — csv_export.py (L1701)
- `get_perf_csv_header` — csv_export.py (L1775)
...
- `process_document_views` — pipeline.py (L540)
- `process_document_views_streaming` — streaming.py (L549)
...
- `run_vop_pipeline_streaming` — streaming.py (L766)
...
- `view_result_to_core_row` — csv_export.py (L1793)
- `view_result_to_occlusion_row` — csv_export.py (L1714)
- `view_result_to_perf_row` — csv_export.py (L2231)
- `view_result_to_vop_row` — csv_export.py (L1927)
