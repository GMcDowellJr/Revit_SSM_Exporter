...
- `_call_name` — tools/gen_maps.py (L148)
...
- `_format_def` — tools/gen_maps.py (L262)
...
- `_is_excluded_dir` — tools/gen_maps.py (L87)
...
- `build_index` — tools/gen_maps.py (L190)
- `build_trace_tree` — tools/gen_maps.py (L329)
...
- `get_core_csv_header` — csv_export.py (L1037)
...
- `get_perf_csv_header` — csv_export.py (L1059)
...
- `get_vop_csv_header` — csv_export.py (L1047)
...
- `iter_py_files` — tools/gen_maps.py (L91)
- `load_ast` — tools/gen_maps.py (L184)
- `main` — tools/gen_maps.py (L422)
...
- `parse_callsites` — tools/gen_maps.py (L163)
- `parse_defs` — tools/gen_maps.py (L131)
- `parse_imports` — tools/gen_maps.py (L115)
...
- `relpath_from_root` — tools/gen_maps.py (L110)
...
- `view_result_to_core_row` — csv_export.py (L1069)
- `view_result_to_perf_row` — csv_export.py (L1470)
- `view_result_to_vop_row` — csv_export.py (L1198)
- `world_to_view` — revit/view_basis.py (L115)
- `write_code_map` — tools/gen_maps.py (L229)
- `write_symbol_index` — tools/gen_maps.py (L266)
- `write_trace_map` — tools/gen_maps.py (L405)
