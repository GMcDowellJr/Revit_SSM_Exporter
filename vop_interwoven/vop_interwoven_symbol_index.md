...
- pipeline.py
  - `process_document_views` (L449)
- streaming.py
  - `process_document_views_streaming` (L488)
- pipeline.py
  - `render_model_front_to_back` (L1226)
- pipeline.py
  - `init_view_raster` (L1039)
- pipeline.py
...
- `_bbox_silhouette` — core/silhouette.py (L1916)
- `_bin_elements_to_tiles` — pipeline.py (L2193)
- `_bounds_to_tuple` — revit/view_basis.py (L630)
- `_bresenham_line` — core/raster.py (L1565)
...
- `_clip_poly_to_rect_uv` — core/raster.py (L1501)
...
- `_convex_hull_2d` — core/silhouette.py (L2611)
...
- `_extract_geometry_footprint_uv` — revit/collection.py (L770)
- `_extract_source_type` — core/raster.py (L8)
- `_extract_view_identity_for_csv` — pipeline.py (L351)
- `_extract_view_summary` — pipeline.py (L1181)
- `_family_region_outlines_cached` — core/silhouette.py (L368)
- `_fix_loop_points_uv` — core/raster.py (L154)
- `_front_face_loops_silhouette` — core/silhouette.py (L2029)
- `_get_ambiguous_tiles` — pipeline.py (L2259)
...
- `_is_supported_2d_view` — pipeline.py (L2079)
- `_iter_curve_primitives` — core/silhouette.py (L1058)
- `_iter_solids` — core/silhouette.py (L2571)
- `_location_curve_obb_silhouette` — core/silhouette.py (L664)
- `_log` — revit/linked_documents.py (L27)
- `_mark_rect_center_cell` — pipeline.py (L2342)
- `_mark_thin_band_along_long_axis` — pipeline.py (L2350)
...
- `_obb_silhouette` — core/silhouette.py (L1968)
- `_order_points_by_connectivity` — core/silhouette.py (L2515)
- `_pca_obb_uv` — revit/collection.py (L1059)
- `_perf_ms` — pipeline.py (L200)
- `_perf_now` — pipeline.py (L195)
- `_pipeline_result_for_json` — entry_dynamo.py (L91)
- `_planar_face_loops_silhouette` — core/silhouette.py (L2367)
...
- `_render_areal_element` — pipeline.py (L2289)
- `_render_proxy_element` — pipeline.py (L2304)
...
- `_should_skip_outside_view_volume` — pipeline.py (L2126)
- `_silhouette_edges` — core/silhouette.py (L2189)
...
- `_stamp_proxy_edges` — pipeline.py (L2329)
...
- `_tile_has_depth_conflict` — pipeline.py (L2225)
- `_tiles_fully_covered_and_nearer` — pipeline.py (L2162)
...
- `_unwrap_elem` — core/silhouette.py (L1572)
- `_uv_obb_rect_from_bbox` — core/silhouette.py (L591)
- `_uv_obb_rect_silhouette` — core/silhouette.py (L1904)
...
- `export_view_raster` — pipeline.py (L2370)
...
- `init_view_raster` — pipeline.py (L1039)
...
- `process_document_views` — pipeline.py (L449)
...
- `render_model_front_to_back` — pipeline.py (L1226)
