...
- pipeline.py
  - `render_model_front_to_back` (L1754)
- pipeline.py
  - `init_view_raster` (L1449)
- pipeline.py
...
- `_bin_elements_to_tiles` — pipeline.py (L3257)
...
- `_build_manifest_vop_row_from_metrics` — csv_export.py (L1176)
...
- `_coerce_view_id_int` — csv_export.py (L320)
...
- `_extract_view_summary` — pipeline.py (L1601)
- `_extract_view_unique_id` — csv_export.py (L416)
...
- `_get_ambiguous_tiles` — pipeline.py (L3323)
...
- `_get_manifest_csv_columns` — csv_export.py (L1168)
- `_get_metrics_triplet_from_view_result` — csv_export.py (L256)
...
- `_intersects_crop_volume` — pipeline.py (L3154)
- `_is_from_cache` — csv_export.py (L18)
- `_is_supported_2d_view` — pipeline.py (L3101)
...
- `_mark_rect_center_cell` — pipeline.py (L3395)
- `_mark_thin_band_along_long_axis` — pipeline.py (L3403)
...
- `_normalize_locked_metrics_for_legacy_csv` — csv_export.py (L218)
...
- `_render_proxy_element` — pipeline.py (L3353)
...
- `_should_skip_outside_view_volume` — pipeline.py (L3180)
...
- `_stamp_proxy_edges` — pipeline.py (L3378)
...
- `_tile_has_depth_conflict` — pipeline.py (L3289)
- `_tiles_fully_covered_and_nearer` — pipeline.py (L3219)
...
- `_viewtype_name_from_value` — csv_export.py (L361)
- `_xyz_tuple` — core/silhouette.py (L429)
- `build_core_csv_row` — csv_export.py (L819)
- `build_occlusion_row` — csv_export.py (L1102)
- `build_vop_csv_row` — csv_export.py (L877)
...
- `compute_annotation_type_metrics` — csv_export.py (L265)
...
- `compute_view_frame_hash` — csv_export.py (L797)
...
- `get_core_csv_header` — csv_export.py (L1537)
...
- `get_occlusion_csv_header` — csv_export.py (L1563)
- `get_perf_csv_header` — csv_export.py (L1637)
...
- `view_result_to_core_row` — csv_export.py (L1654)
- `view_result_to_occlusion_row` — csv_export.py (L1576)
- `view_result_to_perf_row` — csv_export.py (L2085)
- `view_result_to_vop_row` — csv_export.py (L1788)
