...
- pipeline.py
  - `render_model_front_to_back` (L1376)
- pipeline.py
...
- `_bin_elements_to_tiles` — pipeline.py (L2476)
...
- `_get_ambiguous_tiles` — pipeline.py (L2542)
...
- `_is_supported_2d_view` — pipeline.py (L2362)
...
- `_mark_rect_center_cell` — pipeline.py (L2625)
- `_mark_thin_band_along_long_axis` — pipeline.py (L2633)
...
- `_render_areal_element` — pipeline.py (L2572)
- `_render_proxy_element` — pipeline.py (L2587)
...
- `_should_skip_outside_view_volume` — pipeline.py (L2409)
...
- `_stamp_proxy_edges` — pipeline.py (L2612)
...
- `_tile_has_depth_conflict` — pipeline.py (L2508)
- `_tiles_fully_covered_and_nearer` — pipeline.py (L2445)
...
- `export_view_raster` — pipeline.py (L2653)
...
- `render_model_front_to_back` — pipeline.py (L1376)
