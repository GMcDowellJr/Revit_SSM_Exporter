...
- pipeline.py
  - `render_model_front_to_back` (L1353)
- pipeline.py
...
- `_bbox_silhouette` — core/silhouette.py (L1948)
- `_bin_elements_to_tiles` — pipeline.py (L2533)
- `_bounds_to_tuple` — revit/view_basis.py (L630)
- `_bresenham_line` — core/raster.py (L1852)
- `_build_clip_volume` — revit/linked_documents.py (L818)
- `_build_crop_prism_corners` — revit/linked_documents.py (L998)
- `_cache_get` — core/silhouette.py (L338)
- `_cache_set` — core/silhouette.py (L346)
- `_cad_curves_silhouette` — core/silhouette.py (L1267)
- `_canonicalize_plane` — core/face_selection.py (L52)
- `_cell_in_model_clip` — core/raster.py (L26)
- `_cfg_hash` — pipeline.py (L246)
- `_clip_poly_to_rect_uv` — core/raster.py (L1788)
- `_coerce_view_id_int` — csv_export.py (L271)
- `_collect_from_dwg_imports` — revit/linked_documents.py (L577)
- `_collect_from_revit_links` — revit/linked_documents.py (L457)
- `_collect_link_elements_with_clipping` — revit/linked_documents.py (L674)
...
- `_convex_hull_2d` — core/silhouette.py (L2656)
...
- `_diagnose_coordinate_spaces` — revit/collection.py (L785)
...
- `_extract_geometry_footprint_uv` — revit/collection.py (L1012)
...
- `_front_face_loops_silhouette` — core/silhouette.py (L2061)
- `_get_aabb_loops_from_bbox` — core/areal_extraction.py (L53)
- `_get_ambiguous_tiles` — pipeline.py (L2599)
- `_get_element_category_name` — revit/collection.py (L766)
- `_get_excluded_3d_category_ids` — revit/linked_documents.py (L1091)
- `_get_host_visible_model_categories` — revit/linked_documents.py (L1047)
- `_get_plan_view_vertical_range` — revit/linked_documents.py (L939)
- `_has_revit_2024_link_collector` — revit/linked_documents.py (L143)
- `_is_from_cache` — csv_export.py (L17)
- `_is_supported_2d_view` — pipeline.py (L2419)
- `_iter_curve_primitives` — core/silhouette.py (L1080)
- `_iter_solids` — core/silhouette.py (L2616)
- `_location_curve_obb_silhouette` — core/silhouette.py (L664)
- `_log` — revit/linked_documents.py (L27)
- `_mark_rect_center_cell` — pipeline.py (L2671)
- `_mark_thin_band_along_long_axis` — pipeline.py (L2679)
- `_maybe_resize_lru` — core/silhouette.py (L355)
- `_merge_paths_by_endpoints` — core/silhouette.py (L1194)
...
- `_obb_silhouette` — core/silhouette.py (L2000)
- `_order_points_by_connectivity` — core/silhouette.py (L2560)
- `_pca_obb_uv` — revit/collection.py (L1461)
- `_perf_ms` — pipeline.py (L201)
- `_perf_now` — pipeline.py (L196)
- `_pipeline_result_for_json` — entry_dynamo.py (L91)
- `_planar_face_loops_silhouette` — core/silhouette.py (L2399)
...
- `_should_skip_outside_view_volume` — pipeline.py (L2466)
- `_silhouette_edges` — core/silhouette.py (L2221)
...
- `_stamp_proxy_edges` — pipeline.py (L2654)
...
- `_tile_has_depth_conflict` — pipeline.py (L2565)
- `_tiles_fully_covered_and_nearer` — pipeline.py (L2502)
- `_to_host_point` — core/silhouette.py (L1581)
- `_to_xyz_tuple` — core/face_selection.py (L25)
- `_transform_bbox_to_host` — revit/linked_documents.py (L1100)
- `_try_get_category_id` — revit/collection_policy.py (L152)
- `_try_import_bic` — revit/collection_policy.py (L147)
- `_unwrap_elem` — core/silhouette.py (L1603)
- `_uv_obb_rect_from_bbox` — core/silhouette.py (L591)
- `_uv_obb_rect_silhouette` — core/silhouette.py (L1936)
...
- `estimate_depth_from_loops_or_bbox` — revit/collection.py (L520)
- `estimate_depth_range_from_bbox` — revit/collection.py (L548)
- `estimate_nearest_depth_from_bbox` — revit/collection.py (L452)
- `excluded_bic_names_global` — revit/collection_policy.py (L144)
- `expand_host_link_import_model_elements` — revit/collection.py (L290)
...
- `export_view_raster` — pipeline.py (L2697)
...
- `get_element_obb_loops` — revit/collection.py (L1239)
- `get_element_silhouette` — core/silhouette.py (L1615)
...
- `render_model_front_to_back` — pipeline.py (L1353)
...
- `sort_front_to_back` — revit/collection.py (L434)
