...
- `_build_manifest_vop_row_from_metrics` — csv_export.py (L1213)
...
- `_clip_poly_to_rect_uv` — core/raster.py (L2007)
- `_coerce_view_id_int` — csv_export.py (L357)
...
- `_get_manifest_csv_columns` — csv_export.py (L1205)
- `_get_metrics_triplet_from_view_result` — csv_export.py (L293)
...
- `_normalize_locked_metrics_for_legacy_csv` — csv_export.py (L255)
...
- `_viewtype_name_from_value` — csv_export.py (L398)
- `_xyz_tuple` — core/silhouette.py (L429)
- `build_core_csv_row` — csv_export.py (L856)
- `build_occlusion_row` — csv_export.py (L1139)
- `build_vop_csv_row` — csv_export.py (L914)
...
- `compute_annotation_type_metrics` — csv_export.py (L302)
...
- `compute_view_frame_hash` — csv_export.py (L834)
...
- `export_occlusion_diagnostics_csv` — csv_export.py (L1166)
...
- `get_core_csv_header` — csv_export.py (L1574)
...
- `get_occlusion_csv_header` — csv_export.py (L1600)
- `get_perf_csv_header` — csv_export.py (L1674)
...
- `view_result_to_core_row` — csv_export.py (L1691)
- `view_result_to_occlusion_row` — csv_export.py (L1613)
- `view_result_to_perf_row` — csv_export.py (L2122)
- `view_result_to_vop_row` — csv_export.py (L1825)
