...
- `_bbox_silhouette` — core/silhouette.py (L1740)
- `_bin_elements_to_tiles` — pipeline.py (L2155)
...
- `_convex_hull_2d` — core/silhouette.py (L2288)
...
- `_front_face_loops_silhouette` — core/silhouette.py (L1853)
- `_get_ambiguous_tiles` — pipeline.py (L2221)
...
- `_is_supported_2d_view` — pipeline.py (L2041)
- `_iter_curve_primitives` — core/silhouette.py (L1058)
- `_iter_solids` — core/silhouette.py (L2248)
- `_location_curve_obb_silhouette` — core/silhouette.py (L664)
- `_log` — revit/linked_documents.py (L27)
- `_mark_rect_center_cell` — pipeline.py (L2304)
- `_mark_thin_band_along_long_axis` — pipeline.py (L2312)
...
- `_render_areal_element` — pipeline.py (L2251)
- `_render_proxy_element` — pipeline.py (L2266)
...
- `_should_skip_outside_view_volume` — pipeline.py (L2088)
- `_silhouette_edges` — core/silhouette.py (L2013)
...
- `_stamp_proxy_edges` — pipeline.py (L2291)
...
- `_tile_has_depth_conflict` — pipeline.py (L2187)
- `_tiles_fully_covered_and_nearer` — pipeline.py (L2124)
...
- `export_view_raster` — pipeline.py (L2332)
