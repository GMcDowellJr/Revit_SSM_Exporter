...
- streaming.py
  - `run_vop_pipeline_streaming` (L725)
- dynamo_helpers.py
  - `run_pipeline_from_dynamo_input` (L227)
- pipeline.py
  - `process_document_views` (L542)
- streaming.py
  - `process_document_views_streaming` (L579)
- pipeline.py
  - `render_model_front_to_back` (L1904)
- pipeline.py
  - `init_view_raster` (L1599)
- pipeline.py
  - `_view_signature` (L273)
- revit/view_basis.py
...
- `MemoryTracker` — memory_telemetry.py (L51)
...
- `_bin_elements_to_tiles` — pipeline.py (L3441)
...
- `_compute_manifest_metrics_payload` — pipeline.py (L499)
- `_convex_hull_2d` — core/silhouette.py (L3122)
- `_cropbox_fingerprint` — pipeline.py (L228)
...
- `_diagnose_link_geometry_transform` — pipeline.py (L123)
...
- `_extract_view_identity_for_csv` — pipeline.py (L385)
- `_extract_view_summary` — pipeline.py (L1751)
...
- `_get_memory_mb` — memory_telemetry.py (L10)
...
- `_intersects_crop_volume` — pipeline.py (L3338)
...
- `_is_supported_2d_view` — pipeline.py (L3285)
...
- `_mark_rect_center_cell` — pipeline.py (L3579)
- `_mark_thin_band_along_long_axis` — pipeline.py (L3587)
...
- `_perf_ms` — pipeline.py (L211)
- `_perf_now` — pipeline.py (L206)
...
- `_stamp_proxy_edges` — pipeline.py (L3562)
...
- `_tile_has_depth_conflict` — pipeline.py (L3473)
- `_tiles_fully_covered_and_nearer` — pipeline.py (L3403)
...
- `_view_signature` — pipeline.py (L273)
...
- `export_perf_csv` — perf_export.py (L36)
...
- `export_view_raster` — pipeline.py (L3605)
...
- `init_view_raster` — pipeline.py (L1599)
...
- `process_document_views` — pipeline.py (L542)
- `process_document_views_streaming` — streaming.py (L579)
...
- `run_vop_pipeline_streaming` — streaming.py (L725)
