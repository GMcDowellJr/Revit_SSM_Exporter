...
- `_diagnose_coordinate_spaces` — revit/collection.py (L789)
...
- `_extract_geometry_footprint_uv` — revit/collection.py (L1016)
...
- `_mark_rect_center_cell` — pipeline.py (L2682)
- `_mark_thin_band_along_long_axis` — pipeline.py (L2690)
...
- `_pca_obb_uv` — revit/collection.py (L1465)
...
- `_render_areal_element` — pipeline.py (L2629)
- `_render_proxy_element` — pipeline.py (L2644)
...
- `_stamp_proxy_edges` — pipeline.py (L2669)
...
- `export_view_raster` — pipeline.py (L2710)
...
- `get_element_obb_loops` — revit/collection.py (L1243)
