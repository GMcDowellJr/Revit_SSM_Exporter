...
CSV, raw view-raster, root-cache, and element-cache/map outputs are skipped so
`IN[5]` acts as the temporary mode toggle between legacy raster extraction and
