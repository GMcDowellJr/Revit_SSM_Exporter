...
- `_get_solid_pattern_id` (function, L439)
- `_build_flat_color_ogs` (function, L448)
- `_category_id_int` (function, L464)
- `_resolve_colorable_category_predicate` (function, L499)
- `_dedupe_link_instances_by_document` (function, L585)
- `_model_categories_in_linked_doc` (function, L619)
- `_find_existing_parameter_filter` (function, L703)
- `_reused_filter_matches_category` (function, L711)
- `_collect_link_category_filters` (function, L738)
- `_apply_link_category_filters` (function, L789)
- `_finite_or_none` (function, L915)
- `_collect_view_scoped_link_proxies` (function, L930)
- `_near_face_w_category_name` (function, L989)
- `_near_face_w_import_symbol_name` (function, L1008)
- `_near_face_w_view_specific` (function, L1030)
- `_dwg_only_state` (function, L1042)
- `_host_source_state` (function, L1054)
- `_collect_near_face_w_data` (function, L1084)
- `_collect_annotation_bbox_data` (function, L1343)
- `_try_color_link_element_detailed` (function, L1551)
- `_hidden_category_state` (function, L1578)
- `_GsNotApplicable` (class, L1644)
- `_GsNotApplicable.__init__` (method, L1651)
- `_gs_value` (function, L1655)
- `_gs_not_applicable` (function, L1659)
- `_gs_unavailable` (function, L1663)
- `_gs_capture` (function, L1667)
- `_gs_element_name` (function, L1685)
- `_gs_element_ref` (function, L1696)
- `_capture_view_graphics_state` (function, L1707)
- `_element_id_ints` (function, L2042)
- `_build_phase_swap_audit` (function, L2055)
- `read_image_dimensions` (function, L2151)
- `normalize_applied_smooth_edges` (function, L2253)
- `_set_pixel_size_with_backoff` (function, L2266)
