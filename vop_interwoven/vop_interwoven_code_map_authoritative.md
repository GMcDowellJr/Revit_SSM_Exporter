...
- `_is_supported_2d_view` (function, L2339)
- `_should_skip_outside_view_volume` (function, L2386)
- `_tiles_fully_covered_and_nearer` (function, L2422)
- `_bin_elements_to_tiles` (function, L2453)
- `_tile_has_depth_conflict` (function, L2485)
- `_get_ambiguous_tiles` (function, L2519)
- `_render_areal_element` (function, L2549)
- `_render_proxy_element` (function, L2564)
- `_stamp_proxy_edges` (function, L2589)
- `_mark_rect_center_cell` (function, L2602)
- `_mark_thin_band_along_long_axis` (function, L2610)
- `export_view_raster` (function, L2630)
