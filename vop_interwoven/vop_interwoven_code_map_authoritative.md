...
- `ViewRaster._is_valid_cell` (method, L530)
- `ViewRaster.width` (method, L543)
- `ViewRaster.height` (method, L548)
- `ViewRaster.cell_size` (method, L553)
- `ViewRaster.bounds` (method, L558)
- `ViewRaster.get_cell_index` (method, L562)
- `ViewRaster.model_occ_mask` (method, L578)
- `ViewRaster.model_occ_mask` (method, L583)
- `ViewRaster.model_proxy_presence` (method, L587)
- `ViewRaster.model_proxy_presence` (method, L592)
- `ViewRaster.has_model_occ` (method, L595)
- `ViewRaster.has_model_edge` (method, L599)
- `ViewRaster.has_model_proxy` (method, L603)
- `ViewRaster.has_model_present` (method, L607)
- `ViewRaster.try_write_cell` (method, L638)
- `ViewRaster.get_or_create_element_meta_index` (method, L723)
- `ViewRaster.get_or_create_anno_meta_index` (method, L763)
- `ViewRaster.finalize_anno_over_model` (method, L781)
- `ViewRaster.stamp_model_edge_idx` (method, L822)
- `ViewRaster.stamp_proxy_edge_idx` (method, L860)
- `ViewRaster.rasterize_proxy_loops` (method, L890)
- `ViewRaster.rasterize_polygon_to_proxy` (method, L973)
- `ViewRaster.rasterize_polygon_to_anno` (method, L1107)
- `ViewRaster.rasterize_closed_loops_to_proxy_edges` (method, L1208)
- `ViewRaster.rasterize_open_polylines_to_proxy_edges` (method, L1296)
- `ViewRaster._model_clip_mask_np` (method, L1351)
- `ViewRaster.rasterize_silhouette_loops` (method, L1380)
- `ViewRaster._scanline_cells` (method, L1556)
- `ViewRaster._scanline_fill` (method, L1666)
- `ViewRaster.dump_occlusion_debug` (method, L1762)
- `ViewRaster.to_dict` (method, L1867)
- `ViewRaster.from_dict` (method, L1919)
- `ViewRaster.to_debug_dict` (method, L2006)
- `_clip_poly_to_rect_uv` (function, L2068)
- `_bresenham_line` (function, L2132)
...
- `init_view_raster` (function, L1622)
- `_extract_view_summary` (function, L1774)
- `rasterize_areal_loops` (function, L1812)
- `render_model_front_to_back` (function, L1927)
- `_is_supported_2d_view` (function, L3294)
- `_intersects_crop_volume` (function, L3347)
- `_should_skip_outside_view_volume` (function, L3373)
- `_tiles_fully_covered_and_nearer` (function, L3412)
- `_bin_elements_to_tiles` (function, L3450)
- `_tile_has_depth_conflict` (function, L3482)
- `_get_ambiguous_tiles` (function, L3516)
- `_render_proxy_element` (function, L3546)
- `_stamp_proxy_edges` (function, L3571)
- `_mark_rect_center_cell` (function, L3588)
- `_mark_thin_band_along_long_axis` (function, L3596)
- `export_view_raster` (function, L3614)
...
- `run_vop_pipeline_streaming` (function, L742)
