...
- `render_model_front_to_back` (function, L1376)
- `_is_supported_2d_view` (function, L2362)
- `_should_skip_outside_view_volume` (function, L2409)
- `_tiles_fully_covered_and_nearer` (function, L2445)
- `_bin_elements_to_tiles` (function, L2476)
- `_tile_has_depth_conflict` (function, L2508)
- `_get_ambiguous_tiles` (function, L2542)
- `_render_areal_element` (function, L2572)
- `_render_proxy_element` (function, L2587)
- `_stamp_proxy_edges` (function, L2612)
- `_mark_rect_center_cell` (function, L2625)
- `_mark_thin_band_along_long_axis` (function, L2633)
- `export_view_raster` (function, L2653)
