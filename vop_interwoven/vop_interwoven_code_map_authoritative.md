...
- `_is_supported_2d_view` (function, L2309)
- `_should_skip_outside_view_volume` (function, L2356)
- `_tiles_fully_covered_and_nearer` (function, L2392)
- `_bin_elements_to_tiles` (function, L2423)
- `_tile_has_depth_conflict` (function, L2455)
- `_get_ambiguous_tiles` (function, L2489)
- `_render_areal_element` (function, L2519)
- `_render_proxy_element` (function, L2534)
- `_stamp_proxy_edges` (function, L2559)
- `_mark_rect_center_cell` (function, L2572)
- `_mark_thin_band_along_long_axis` (function, L2580)
- `export_view_raster` (function, L2600)
