...
**Definitions**
- `_reserved_corner_count` (function, L44)
- `choose_step` (function, L58)
- `build_palette` (function, L75)
- `resolve_all` (function, L96)
- `_split_expanded_elements` (function, L131)
- `get_or_create_neutral_phase_filter` (function, L165)
- `_get_solid_pattern_id` (function, L180)
- `_build_flat_color_ogs` (function, L189)
- `_try_color_link_element` (function, L205)
- `_hidden_category_state` (function, L225)
- `_set_pixel_size_with_backoff` (function, L263)
- `_export_tiff` (function, L297)
- `export_color_id_buffer_view` (function, L338)
...
- `Config.compute_adaptive_tile_size` (method, L353)
- `Config.max_grid_cells_width` (method, L403)
- `Config.max_grid_cells_height` (method, L412)
- `Config.bounds_buffer_ft` (method, L421)
- `Config.silhouette_tiny_thresh_ft` (method, L430)
- `Config.silhouette_large_thresh_ft` (method, L439)
- `Config.coarse_tess_max_verts` (method, L448)
- `Config.get_silhouette_strategies` (method, L456)
- `Config.__repr__` (method, L490)
- `Config.to_dict` (method, L510)
- `Config.from_dict` (method, L582)
...
- `get_element_silhouette` (function, L1923)
- `_uv_obb_rect_silhouette` (function, L2354)
- `_bbox_silhouette` (function, L2366)
- `_obb_silhouette` (function, L2418)
- `_front_face_loops_silhouette` (function, L2479)
- `_silhouette_edges` (function, L2650)
- `_planar_face_loops_silhouette` (function, L2829)
- `_order_points_by_connectivity` (function, L3050)
- `_iter_solids` (function, L3106)
- `_convex_hull_2d` (function, L3146)
...
- `build_vop_csv_row` (function, L1072)
- `build_occlusion_row` (function, L1297)
- `export_occlusion_diagnostics_csv` (function, L1324)
- `_get_manifest_csv_columns` (function, L1363)
- `_build_manifest_vop_row_from_metrics` (function, L1371)
- `export_pipeline_to_csv` (function, L1385)
- `get_core_csv_header` (function, L1735)
- `get_vop_csv_header` (function, L1746)
- `get_occlusion_csv_header` (function, L1761)
- `view_result_to_occlusion_row` (function, L1774)
- `get_perf_csv_header` (function, L1835)
- `view_result_to_core_row` (function, L1854)
- `view_result_to_vop_row` (function, L1988)
- `view_result_to_perf_row` (function, L2336)
...
- `_extract_view_identity_for_csv` (function, L376)
- `_compute_manifest_metrics_payload` (function, L490)
- `process_document_views` (function, L533)
- `init_view_raster` (function, L1673)
- `_extract_view_summary` (function, L1825)
- `rasterize_areal_loops` (function, L1863)
- `_make_areal_geom_cache_key` (function, L2019)
- `_reconstruct_areal_low_conf_loops` (function, L2033)
- `_quantize_view_dir` (function, L2129)
- `_make_areal_high_conf_cache_key` (function, L2151)
- `_reconstruct_areal_high_conf_loops` (function, L2174)
- `render_model_front_to_back` (function, L2217)
- `_is_supported_2d_view` (function, L3794)
- `_intersects_crop_volume` (function, L3847)
- `_should_skip_outside_view_volume` (function, L3873)
- `_tiles_fully_covered_and_nearer` (function, L3912)
- `_bin_elements_to_tiles` (function, L3950)
- `_tile_has_depth_conflict` (function, L3982)
- `_get_ambiguous_tiles` (function, L4016)
- `_render_proxy_element` (function, L4046)
- `_stamp_proxy_edges` (function, L4071)
- `_mark_rect_center_cell` (function, L4088)
- `_mark_thin_band_along_long_axis` (function, L4096)
- `export_view_raster` (function, L4114)
...
- `sort_front_to_back` (function, L495)
- `estimate_nearest_depth_from_bbox` (function, L513)
- `estimate_depth_from_loops_or_bbox` (function, L589)
- `estimate_depth_range_from_bbox` (function, L617)
- `_project_element_bbox_to_cell_rect` (function, L746)
- `_get_element_category_name` (function, L918)
- `_diagnose_coordinate_spaces` (function, L937)
- `_extract_geometry_footprint_uv` (function, L1164)
- `get_element_obb_loops` (function, L1439)
- `_pca_obb_uv` (function, L1703)
...
- `annotation_included_bic_names` (function, L147)
- `excluded_bic_names_global` (function, L157)
- `_try_import_bic` (function, L161)
- `_try_get_category_id` (function, L167)
- `resolve_category_ids` (function, L182)
- `_try_get_category_type_model` (function, L206)
- `should_include_element` (function, L215)
...
- `collect_all_linked_elements` (function, L102)
- `_has_revit_2024_link_collector` (function, L148)
- `_collect_visible_link_elements_2024_plus` (function, L191)
- `_collect_from_revit_links` (function, L504)
- `_collect_from_dwg_imports` (function, L624)
- `_collect_link_elements_with_clipping` (function, L721)
- `_build_clip_volume` (function, L865)
- `_get_plan_view_vertical_range` (function, L986)
- `_build_crop_prism_corners` (function, L1045)
- `_get_host_visible_model_categories` (function, L1094)
- `_get_excluded_3d_category_ids` (function, L1138)
- `_transform_bbox_to_host` (function, L1147)
...
- `_view_type_name` (function, L1224)
- `supports_model_geometry` (function, L1335)
- `supports_crop_bounds` (function, L1379)
- `supports_depth` (function, L1405)
- `resolve_view_mode` (function, L1419)
- `resolve_annotation_only_bounds` (function, L1472)
...
- `StreamingExporter` (class, L115)
- `StreamingExporter.__init__` (method, L118)
- `StreamingExporter._init_csv_writers` (method, L207)
- `StreamingExporter.on_view_complete` (method, L276)
- `StreamingExporter._write_png` (method, L387)
- `StreamingExporter._write_view_raster` (method, L415)
- `StreamingExporter._write_csv_rows` (method, L481)
- `StreamingExporter._extract_summary` (method, L620)
- `StreamingExporter.finalize` (method, L633)
- `process_document_views_streaming` (function, L688)
- `run_vop_pipeline_streaming` (function, L979)
...
**Definitions**
- `_to_sequence` (function, L44)
- `_resolve_view_object` (function, L79)
- `_build_views_from_input` (function, L129)
- `_coerce_view_id` (function, L145)
- `_safe_level_elevation` (function, L180)
- `sort_views_by_level` (function, L211)
- `_chunk_list` (function, L286)
- `_append_csv` (function, L292)
- `_run_gc_between_chunks` (function, L313)
...
- `_dot` (function, L66)
- `_prepare_view_for_export` (function, L70)
- `export_view_image` (function, L273)
- `_resize_to_exact` (function, L399)
- `export_pipeline_views_to_pngs` (function, L452)
