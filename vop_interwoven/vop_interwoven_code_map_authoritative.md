...
- `ViewRaster._is_valid_cell` (method, L394)
- `ViewRaster.width` (method, L407)
- `ViewRaster.height` (method, L412)
- `ViewRaster.cell_size` (method, L417)
- `ViewRaster.bounds` (method, L422)
- `ViewRaster.get_cell_index` (method, L426)
- `ViewRaster.model_occ_mask` (method, L442)
- `ViewRaster.model_occ_mask` (method, L447)
- `ViewRaster.model_proxy_presence` (method, L451)
- `ViewRaster.model_proxy_presence` (method, L456)
- `ViewRaster.has_model_occ` (method, L459)
- `ViewRaster.has_model_edge` (method, L463)
- `ViewRaster.has_model_proxy` (method, L467)
- `ViewRaster.has_model_present` (method, L471)
- `ViewRaster.try_write_cell` (method, L502)
- `ViewRaster.get_or_create_element_meta_index` (method, L573)
- `ViewRaster.get_or_create_anno_meta_index` (method, L613)
- `ViewRaster.finalize_anno_over_model` (method, L631)
- `ViewRaster.stamp_model_edge_idx` (method, L667)
- `ViewRaster.stamp_proxy_edge_idx` (method, L699)
- `ViewRaster.rasterize_proxy_loops` (method, L723)
- `ViewRaster.rasterize_silhouette_loops` (method, L792)
- `ViewRaster._scanline_fill` (method, L878)
- `ViewRaster.dump_occlusion_debug` (method, L944)
- `ViewRaster.to_dict` (method, L1049)
- `ViewRaster.from_dict` (method, L1091)
- `ViewRaster.to_debug_dict` (method, L1147)
- `_clip_poly_to_rect_uv` (function, L1202)
- `_bresenham_line` (function, L1266)
...
- `_iter_curve_primitives` (function, L913)
- `_merge_paths_by_endpoints` (function, L1027)
- `_cad_curves_silhouette` (function, L1100)
- `_to_host_point` (function, L1414)
- `_unwrap_elem` (function, L1427)
- `get_element_silhouette` (function, L1439)
- `_uv_obb_rect_silhouette` (function, L1574)
- `_bbox_silhouette` (function, L1586)
- `_obb_silhouette` (function, L1638)
- `_front_face_loops_silhouette` (function, L1699)
- `_silhouette_edges` (function, L1859)
- `_order_points_by_connectivity` (function, L2038)
- `_iter_solids` (function, L2094)
- `_convex_hull_2d` (function, L2134)
...
- `_extract_view_identity_for_csv` (function, L353)
- `process_document_views` (function, L451)
- `init_view_raster` (function, L1041)
- `_extract_view_summary` (function, L1183)
- `render_model_front_to_back` (function, L1228)
- `_is_supported_2d_view` (function, L1863)
- `_tiles_fully_covered_and_nearer` (function, L1910)
- `_bin_elements_to_tiles` (function, L1941)
- `_tile_has_depth_conflict` (function, L1973)
- `_get_ambiguous_tiles` (function, L2007)
- `_render_areal_element` (function, L2037)
- `_render_proxy_element` (function, L2052)
- `_stamp_proxy_edges` (function, L2077)
- `_mark_rect_center_cell` (function, L2090)
- `_mark_thin_band_along_long_axis` (function, L2098)
- `export_view_raster` (function, L2118)
...
- `get_element_obb_loops` (function, L853)
- `_pca_obb_uv` (function, L1008)
