...
- `_is_from_cache` (function, L148)
- `compute_external_cell_metrics` (function, L169)
- `compute_cell_metrics` (function, L238)
- `_compute_cell_metrics_np` (function, L253)
- `_compute_cell_metrics_py` (function, L325)
- `compute_annotation_type_metrics` (function, L403)
- `_coerce_view_id_int` (function, L458)
- `_viewtype_name_from_value` (function, L499)
- `_extract_view_unique_id` (function, L554)
- `extract_view_metadata` (function, L586)
- `compute_config_hash` (function, L903)
- `compute_view_frame_hash` (function, L935)
- `build_core_csv_row` (function, L957)
- `build_vop_csv_row` (function, L1015)
- `build_occlusion_row` (function, L1240)
- `export_occlusion_diagnostics_csv` (function, L1267)
- `_get_manifest_csv_columns` (function, L1306)
- `_build_manifest_vop_row_from_metrics` (function, L1314)
- `export_pipeline_to_csv` (function, L1328)
- `get_core_csv_header` (function, L1675)
- `get_vop_csv_header` (function, L1686)
- `get_occlusion_csv_header` (function, L1701)
- `view_result_to_occlusion_row` (function, L1714)
- `get_perf_csv_header` (function, L1775)
- `view_result_to_core_row` (function, L1793)
- `view_result_to_vop_row` (function, L1927)
- `view_result_to_perf_row` (function, L2231)
...
- `_is_supported_2d_view` (function, L3303)
- `_intersects_crop_volume` (function, L3356)
- `_should_skip_outside_view_volume` (function, L3382)
- `_tiles_fully_covered_and_nearer` (function, L3421)
- `_bin_elements_to_tiles` (function, L3459)
- `_tile_has_depth_conflict` (function, L3491)
- `_get_ambiguous_tiles` (function, L3525)
- `_render_proxy_element` (function, L3555)
- `_stamp_proxy_edges` (function, L3580)
- `_mark_rect_center_cell` (function, L3597)
- `_mark_thin_band_along_long_axis` (function, L3605)
- `export_view_raster` (function, L3623)
