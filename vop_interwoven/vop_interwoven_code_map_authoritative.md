...
**Definitions**
- `Config` (class, L11)
- `Config.__init__` (method, L56)
- `Config.compute_adaptive_tile_size` (method, L275)
- `Config.max_grid_cells_width` (method, L325)
- `Config.max_grid_cells_height` (method, L334)
- `Config.bounds_buffer_ft` (method, L343)
- `Config.silhouette_tiny_thresh_ft` (method, L352)
- `Config.silhouette_large_thresh_ft` (method, L361)
- `Config.coarse_tess_max_verts` (method, L370)
- `Config.get_silhouette_strategies` (method, L378)
- `Config.__repr__` (method, L410)
- `Config.to_dict` (method, L430)
- `Config.from_dict` (method, L475)
...
- `mark_rect_center_cell` (function, L297)
- `mark_thin_band_along_long_axis` (function, L320)
...
- `ViewRaster` (class, L155)
- `ViewRaster._cell_in_model_clip` (method, L212)
- `ViewRaster.rasterize_open_polylines` (method, L233)
- `ViewRaster.__init__` (method, L337)
- `ViewRaster.width` (method, L395)
- `ViewRaster.height` (method, L400)
- `ViewRaster.cell_size` (method, L405)
- `ViewRaster.bounds` (method, L410)
- `ViewRaster.get_cell_index` (method, L414)
- `ViewRaster.model_occ_mask` (method, L430)
- `ViewRaster.model_occ_mask` (method, L435)
- `ViewRaster.model_proxy_presence` (method, L439)
- `ViewRaster.model_proxy_presence` (method, L444)
- `ViewRaster.has_model_occ` (method, L447)
- `ViewRaster.has_model_edge` (method, L451)
- `ViewRaster.has_model_proxy` (method, L455)
- `ViewRaster.has_model_present` (method, L459)
- `ViewRaster.try_write_cell` (method, L490)
- `ViewRaster.get_or_create_element_meta_index` (method, L548)
- `ViewRaster.get_or_create_anno_meta_index` (method, L588)
- `ViewRaster.finalize_anno_over_model` (method, L606)
- `ViewRaster.stamp_model_edge_idx` (method, L642)
- `ViewRaster.stamp_proxy_edge_idx` (method, L674)
- `ViewRaster.rasterize_proxy_loops` (method, L698)
- `ViewRaster.rasterize_silhouette_loops` (method, L767)
- `ViewRaster._scanline_fill` (method, L853)
- `ViewRaster.dump_occlusion_debug` (method, L917)
- `ViewRaster.to_dict` (method, L1022)
- `ViewRaster.from_dict` (method, L1064)
- `ViewRaster.to_debug_dict` (method, L1120)
- `_clip_poly_to_rect_uv` (function, L1175)
- `_bresenham_line` (function, L1239)
...
- `_symbolic_curves_silhouette` (function, L708)
- `_iter_curve_primitives` (function, L910)
- `_merge_paths_by_endpoints` (function, L1024)
- `_cad_curves_silhouette` (function, L1097)
- `_to_host_point` (function, L1411)
- `_unwrap_elem` (function, L1424)
- `get_element_silhouette` (function, L1436)
- `_uv_obb_rect_silhouette` (function, L1571)
- `_bbox_silhouette` (function, L1583)
- `_obb_silhouette` (function, L1644)
- `_front_face_loops_silhouette` (function, L1705)
- `_silhouette_edges` (function, L1865)
- `_order_points_by_connectivity` (function, L2044)
- `_iter_solids` (function, L2100)
- `_convex_hull_2d` (function, L2140)
...
**Definitions**
- `_perf_now` (function, L111)
- `_perf_ms` (function, L116)
- `_safe_int` (function, L119)
- `_safe_bool` (function, L126)
- `_cropbox_fingerprint` (function, L133)
- `_cfg_hash` (function, L161)
- `_view_signature` (function, L177)
- `_extract_view_identity_for_csv` (function, L269)
- `process_document_views` (function, L367)
- `init_view_raster` (function, L957)
- `_extract_view_summary` (function, L1094)
- `render_model_front_to_back` (function, L1139)
- `_is_supported_2d_view` (function, L1726)
- `_tiles_fully_covered_and_nearer` (function, L1773)
- `_bin_elements_to_tiles` (function, L1804)
- `_tile_has_depth_conflict` (function, L1836)
- `_get_ambiguous_tiles` (function, L1870)
- `_render_areal_element` (function, L1900)
- `_render_proxy_element` (function, L1915)
- `_stamp_proxy_edges` (function, L1940)
- `_mark_rect_center_cell` (function, L1953)
- `_mark_thin_band_along_long_axis` (function, L1961)
- `export_view_raster` (function, L1981)
...
- `_uv_to_cell` (function, L1026)
- `_stamp_cell` (function, L1035)
- `_stamp_rect_outline` (function, L1042)
- `_stamp_line_cells` (function, L1062)
- `_project_element_bbox_to_cell_rect_for_anno` (function, L1083)

### `revit/collection.py`

**Definitions**
- `resolve_element_bbox` (function, L8)
- `collect_view_elements` (function, L62)
- `is_element_visible_in_view` (function, L264)
- `expand_host_link_import_model_elements` (function, L292)
- `sort_front_to_back` (function, L436)
- `estimate_nearest_depth_from_bbox` (function, L454)
- `estimate_depth_from_loops_or_bbox` (function, L522)
- `estimate_depth_range_from_bbox` (function, L550)
- `_project_element_bbox_to_cell_rect` (function, L624)
- `_extract_geometry_footprint_uv` (function, L737)
- `get_element_obb_loops` (function, L846)
- `_pca_obb_uv` (function, L1001)
...
- `_collect_from_revit_links` (function, L393)
- `_collect_from_dwg_imports` (function, L513)
- `_collect_link_elements_with_clipping` (function, L610)
- `_build_clip_volume` (function, L754)
- `_get_plan_view_vertical_range` (function, L875)
- `_build_crop_prism_corners` (function, L934)
- `_get_host_visible_model_categories` (function, L983)
- `_get_excluded_3d_category_ids` (function, L1027)
- `_transform_bbox_to_host` (function, L1036)
...
- `xy_bounds_from_crop_box_all_corners` (function, L212)
- `xy_bounds_effective` (function, L279)
- `synthetic_bounds_from_visible_extents` (function, L312)
- `_bounds_to_tuple` (function, L554)
- `resolve_view_bounds` (function, L561)
- `_view_type_name` (function, L900)
- `supports_model_geometry` (function, L1004)
- `supports_crop_bounds` (function, L1041)
- `supports_depth` (function, L1060)
- `resolve_view_mode` (function, L1074)
- `resolve_annotation_only_bounds` (function, L1120)
...
- `run_vop_pipeline_streaming` (function, L565)
