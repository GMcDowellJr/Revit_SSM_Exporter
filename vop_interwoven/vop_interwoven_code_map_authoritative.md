...
- `ViewRaster._scanline_cells` (method, L1567)
- `ViewRaster._scanline_fill` (method, L1677)
- `ViewRaster.dump_occlusion_debug` (method, L1773)
- `ViewRaster.to_dict` (method, L1878)
- `ViewRaster.from_dict` (method, L1930)
- `ViewRaster.to_debug_dict` (method, L2017)
- `_clip_poly_to_rect_uv` (function, L2079)
- `_bresenham_line` (function, L2143)
...
- `_compute_cell_metrics_np` (function, L160)
- `_compute_cell_metrics_py` (function, L228)
- `_normalize_locked_metrics_for_legacy_csv` (function, L302)
- `_get_metrics_triplet_from_view_result` (function, L340)
- `compute_annotation_type_metrics` (function, L349)
- `_coerce_view_id_int` (function, L404)
- `_viewtype_name_from_value` (function, L445)
- `_extract_view_unique_id` (function, L500)
- `extract_view_metadata` (function, L532)
- `compute_config_hash` (function, L849)
- `compute_view_frame_hash` (function, L881)
- `build_core_csv_row` (function, L903)
- `build_vop_csv_row` (function, L961)
- `build_occlusion_row` (function, L1186)
- `export_occlusion_diagnostics_csv` (function, L1213)
- `_get_manifest_csv_columns` (function, L1252)
- `_build_manifest_vop_row_from_metrics` (function, L1260)
- `export_pipeline_to_csv` (function, L1274)
- `get_core_csv_header` (function, L1621)
- `get_vop_csv_header` (function, L1632)
- `get_occlusion_csv_header` (function, L1647)
- `view_result_to_occlusion_row` (function, L1660)
- `get_perf_csv_header` (function, L1721)
- `view_result_to_core_row` (function, L1738)
- `view_result_to_vop_row` (function, L1872)
- `view_result_to_perf_row` (function, L2169)
...
- `init_view_raster` (function, L1599)
- `_extract_view_summary` (function, L1751)
- `rasterize_areal_loops` (function, L1789)
- `render_model_front_to_back` (function, L1904)
- `_is_supported_2d_view` (function, L3285)
- `_intersects_crop_volume` (function, L3338)
- `_should_skip_outside_view_volume` (function, L3364)
- `_tiles_fully_covered_and_nearer` (function, L3403)
- `_bin_elements_to_tiles` (function, L3441)
- `_tile_has_depth_conflict` (function, L3473)
- `_get_ambiguous_tiles` (function, L3507)
- `_render_proxy_element` (function, L3537)
- `_stamp_proxy_edges` (function, L3562)
- `_mark_rect_center_cell` (function, L3579)
- `_mark_thin_band_along_long_axis` (function, L3587)
- `export_view_raster` (function, L3605)
...
**Definitions**
- `_export_png_dotnet` (function, L10)
- `_export_png_pillow` (function, L334)
- `export_raster_to_png` (function, L407)
- `export_pipeline_results_to_pngs` (function, L430)
...
- `StreamingExporter._write_png` (method, L352)
- `StreamingExporter._write_csv_rows` (method, L380)
- `StreamingExporter._extract_summary` (method, L500)
- `StreamingExporter.finalize` (method, L513)
- `process_document_views_streaming` (function, L579)
- `run_vop_pipeline_streaming` (function, L725)
