...
- `init_view_raster` (function, L1308)
- `_extract_view_summary` (function, L1460)
- `rasterize_areal_loops` (function, L1498)
- `render_model_front_to_back` (function, L1613)
- `_is_supported_2d_view` (function, L2962)
- `_intersects_crop_volume` (function, L3015)
- `_should_skip_outside_view_volume` (function, L3041)
- `_tiles_fully_covered_and_nearer` (function, L3080)
- `_bin_elements_to_tiles` (function, L3118)
- `_tile_has_depth_conflict` (function, L3150)
- `_get_ambiguous_tiles` (function, L3184)
- `_render_proxy_element` (function, L3214)
- `_stamp_proxy_edges` (function, L3239)
- `_mark_rect_center_cell` (function, L3256)
- `_mark_thin_band_along_long_axis` (function, L3264)
- `export_view_raster` (function, L3282)
