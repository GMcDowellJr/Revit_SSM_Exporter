...
- `_is_supported_2d_view` (function, L2355)
- `_should_skip_outside_view_volume` (function, L2402)
- `_tiles_fully_covered_and_nearer` (function, L2438)
- `_bin_elements_to_tiles` (function, L2469)
- `_tile_has_depth_conflict` (function, L2501)
- `_get_ambiguous_tiles` (function, L2535)
- `_render_areal_element` (function, L2565)
- `_render_proxy_element` (function, L2580)
- `_stamp_proxy_edges` (function, L2605)
- `_mark_rect_center_cell` (function, L2618)
- `_mark_thin_band_along_long_axis` (function, L2626)
- `export_view_raster` (function, L2646)
