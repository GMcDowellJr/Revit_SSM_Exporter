...
- `init_view_raster` (function, L1296)
- `_extract_view_summary` (function, L1448)
- `rasterize_areal_loops` (function, L1486)
- `render_model_front_to_back` (function, L1601)
- `_is_supported_2d_view` (function, L2950)
- `_intersects_crop_volume` (function, L3003)
- `_should_skip_outside_view_volume` (function, L3029)
- `_tiles_fully_covered_and_nearer` (function, L3068)
- `_bin_elements_to_tiles` (function, L3106)
- `_tile_has_depth_conflict` (function, L3138)
- `_get_ambiguous_tiles` (function, L3172)
- `_render_proxy_element` (function, L3202)
- `_stamp_proxy_edges` (function, L3227)
- `_mark_rect_center_cell` (function, L3244)
- `_mark_thin_band_along_long_axis` (function, L3252)
- `export_view_raster` (function, L3270)
