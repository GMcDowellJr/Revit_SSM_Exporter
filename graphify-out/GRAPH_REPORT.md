# Graph Report - Revit_SSM_Exporter  (2026-08-24)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 2198 nodes · 4123 edges · 118 communities (105 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.71)
- Token cost: 7,793 input · 1,096 output

## Graph Freshness
- Built from commit: `3e8c703c`
...
- Stage A Probe Contract
- Early Out Semantics Testing
- Color ID Buffer Tests
...
- Resolution Management Utilities
...
- Raster Export for JSON
- View Identity Extraction
- General
- Annotation Classification Types
- Campaign Planning
- Enumeration
- Path Definition
...
1. `Config` - 82 edges
2. `probe_stage_a_minimum_id_mutations.py` - 72 edges
3. `probe_stage_a_model_linework.py` - 61 edges
4. `probe_stage_a_external_sources.py` - 59 edges
5. `probe_stage_a_graphics_semantics.py` - 57 edges
6. `probe_stage_a_image_alignment.py` - 53 edges
7. `Files` - 40 edges
8. `_run_native()` - 30 edges
9. `load_manifest()` - 29 edges
10. `_FakeElem` - 26 edges
...
- **Stage A Probes** — tests_dynamo_probe_stage_a_external_sources, tests_dynamo_probe_stage_a_graphics_semantics, tests_dynamo_probe_stage_a_image_alignment, tests_dynamo_probe_stage_a_minimum_id_mutations, tests_dynamo_probe_stage_a_model_linework [EXTRACTED 0.75]
...
### Community 0 - "Mock Object Definitions"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (86): probe_stage_a_minimum_id_mutations.py, _active_crop_bounds(), _add_repo_root_to_path(), all_mutation_statuses(), analyze_tiff(), _apply_flat_colors(), _apply_mutation(), apply_resolution_cap() (+78 more)

### Community 2 - "Stage A Acceptance Tests"
Cohesion: 0.06
...
### Community 3 - "Revit Integration Tests"
Cohesion: 0.07
...
### Community 4 - "Geometry Cache Tests"
Cohesion: 0.07
...
### Community 5 - "Depth Calculation Utilities"
Cohesion: 0.07
...
### Community 6 - "External Source Probing"
Cohesion: 0.08
Nodes (59): probe_stage_a_external_sources.py, _active_crop_bounds(), _actual_tiff_dimensions(), _analyze(), _apply_assignments(), apply_resolution_cap(), _bounds_tuple(), build_resolution_report() (+51 more)

### Community 7 - "Image Alignment Probing"
Cohesion: 0.08
Nodes (59): probe_stage_a_image_alignment.py, _actual_tiff_dimensions(), _analyze_image(), apply_resolution_cap(), _bounds_dict(), _bounds_tuple(), _build_marker_ogs(), build_resolution_report() (+51 more)

### Community 8 - "Module Import Tests"
Cohesion: 0.04
Nodes (33): Import Check - Verify all modules load correctly  This tests if the linked docum, Test Linked Documents Collection - Debug Script  Paste this into a Dynamo Python, Minimal Single View Test - Step-by-step diagnostic  This will show exactly where, Unit tests for VOP interwoven pipeline.  Test modules: - test_geometry: UV class, Test that percentage columns are in valid 0-100 range., Test that build_vop_csv_row works without strategy_diag (backward compat)., Test that strategy counts sum to expected totals., Test that CSV export doesn't crash if diagnostic extraction fails. (+25 more)

### Community 9 - "Fake Element Testing"
Cohesion: 0.06
...
### Community 10 - "Occlusion Contract Tests"
Cohesion: 0.06
...
### Community 11 - "Implementation Planning"
Cohesion: 0.07
...
### Community 12 - "Configuration Hash Tests"
Cohesion: 0.06
Nodes (32): test_csv_config_hash_matches_root_cache_config_hash_for_real_config(), _Cfg, test_core_row_uses_view_unique_id_without_view_object(), test_root_cache_metadata_carries_view_unique_id(), test_root_cache_row_payload_stores_uid_from_pascal_metadata(), test_vop_cache_row_uses_view_result_uid_when_cached_payload_missing_uid(), test_vop_row_uses_view_unique_id_without_view_object(), _Cfg (+24 more)
...
### Community 14 - "Model Linework Probing"
Cohesion: 0.10
Nodes (48): probe_stage_a_model_linework.py, _actual_tiff_dimensions(), _analyze_image(), _apply_category_linework(), _apply_element_id_reference(), _apply_mode(), _candidate_repo_roots(), _detach_template() (+40 more)

### Community 15 - "Streaming Pipeline Processing"
Cohesion: 0.06
...
### Community 16 - "Manifest Loader Tests"
Cohesion: 0.11
...
### Community 18 - "Areal Extraction Tests"
Cohesion: 0.14
Nodes (36): AST, Module, _call_name(), _calls_named(), _find_element_loop(), _find_function(), _is_elem_class_areal_if(), Static regression tests for the AREAL HIGH single-extraction contract. (+28 more)

### Community 19 - "VOP Interwoven Code Map"
Cohesion: 0.05
...
### Community 20 - "Transaction Group Export"
Cohesion: 0.13
...
### Community 21 - "Campaign Planning"
Cohesion: 0.21
...
### Community 22 - "Bounds Budget Testing"
Cohesion: 0.14
...
Cohesion: 0.14
Nodes (28): probe_stage_a_graphics_semantics.py, _actual_tiff_dimensions(), _analyze_image(), _collect_elements(), _detach_template(), _diff(), _disable_filters(), _exception_record() (+20 more)

### Community 24 - "Geometry Extraction Utilities"
Cohesion: 0.08
...
### Community 25 - "Testing Workflow Documentation"
Cohesion: 0.08
Nodes (24): Golden Baseline Regression Testing, Dynamo Test Scripts, "0 views processed", AttributeError: 'Bounds2D' object has no attribute 'min_x', "AttributeError: 'View3D' object has no attribute...", Example Dynamo Python Node Setup, "ImportError: No module named vop_interwoven", Next Steps (+16 more)

### Community 26 - "Stage A Probe Contract"
Cohesion: 0.13
...
### Community 27 - "Early Out Semantics Testing"
Cohesion: 0.10
Nodes (24): _snapshot_occ(), test_early_out_is_pure_optimization_no_output_difference(), _bin_elements_to_tiles(), _diagnose_link_geometry_transform(), _extract_view_summary(), _make_areal_geom_cache_key(), _perf_ms(), _perf_now() (+16 more)

### Community 28 - "Color ID Buffer Tests"
Cohesion: 0.13
...
### Community 29 - "Phase Validation Tests"
Cohesion: 0.12
Nodes (16): _collect_model_category_ids(), _collect_reference_elements(), `test_all_phases.py` - Quick Validation, Test Scripts, `thinrunner.py` - Quick Iteration Runner, All Phases Test: Quick validation of all implemented phases  Copy this code into, Phase 1 Test: View Basis & Coordinate System  Copy this code into a Dynamo Pytho, Phase 2 Test: Element Collection & Bounding Boxes  Copy this code into a Dynamo (+8 more)

### Community 30 - "Pipeline Diagnostics Testing"
Cohesion: 0.08
...
### Community 33 - "Campaign Planner Tests"
Cohesion: 0.36
...
### Community 35 - "CSV Export Implementation"
Cohesion: 0.11
Nodes (19): Core CSV Headers (18 columns), CSV Headers Reference, Current Output Format (VOP Interwoven), Current Outputs Generated, Dependencies, Future Enhancements (Post-Phase 7), Gap Analysis: Current vs. Target, Integration Test (Dynamo) (+11 more)

### Community 36 - "Phase 7 CSV Export Tests"
Cohesion: 0.14
...
### Community 37 - "Strategy Diagnostics Testing"
Cohesion: 0.11
...
### Community 38 - "Color ID Buffer Extraction"
Cohesion: 0.17
...
### Community 41 - "View Raster Export"
Cohesion: 0.17
...
### Community 42 - "Coding Principles"
Cohesion: 0.14
...
### Community 43 - "UV Classification Testing"
Cohesion: 0.12
...
### Community 44 - "Exception Handling Fixes"
Cohesion: 0.18
...
### Community 45 - "Core Data Structures"
Cohesion: 0.12
...
### Community 46 - "Transform Binning Tests"
Cohesion: 0.26
...
### Community 47 - "Resolution Management Utilities"
Cohesion: 0.26
Nodes (14): _active_crop_bounds(), apply_resolution_cap(), _bounds_tuple(), build_resolution_report(), calculate_canvas_placement(), calculate_paper_space_resolution(), _current_resolution_bounds(), _parse_dpi_values() (+6 more)

### Community 48 - "Depth Convention Testing"
Cohesion: 0.20
...
### Community 49 - "Exclusion Filter Testing"
Cohesion: 0.14
...
### Community 50 - "Front Face Strategy Testing"
Cohesion: 0.23
...
### Community 53 - "AI Assistant Guide"
Cohesion: 0.15
...
### Community 54 - "Operational Review"
Cohesion: 0.15
...
### Community 55 - "Bounding Box Policy Testing"
Cohesion: 0.28
...
### Community 58 - "Resolution Management Utilities"
Cohesion: 0.32
...
### Community 59 - "Face Selection Testing"
Cohesion: 0.26
...
### Community 60 - "Proxy Generation Testing"
Cohesion: 0.17
...
### Community 61 - "TileMap Testing"
Cohesion: 0.17
Nodes (7): Test TileMap spatial acceleration structure., Test tile index calculation., Test tile collection for rectangle., Test tile fullness detection., Test filled count updates., Test minimum W-depth updates., TestTileMap

### Community 62 - "View Coordinate System"
Cohesion: 0.18
...
### Community 63 - "Proxy Edge Management"
Cohesion: 0.18
...
### Community 64 - "View Resolution Management"
Cohesion: 0.22
...
### Community 65 - "Manifest Generation"
Cohesion: 0.20
...
### Community 66 - "Pipeline Architecture Principles"
Cohesion: 0.20
...
### Community 69 - "Element Cache Testing"
Cohesion: 0.33
...
### Community 70 - "Raster Semantics Testing"
Cohesion: 0.22
...
### Community 71 - "Annotation Bounds Calculation"
Cohesion: 0.25
...
### Community 72 - "Occupancy Metrics"
Cohesion: 0.29
Nodes (8): 8-State Occupancy Cell Partition Invariant, External Cell Metrics (ExtFinalCells_DWG / _RVT Set Relationships), Multihot Model Class Cells (ModelClassCells_*), Legacy 4-Way Occupancy Partition (views_vop CSV), SSM-Compatible CSV Export Format, Metrics Totals Relationships Cheat Sheet, Phase 7 CSV Export Plan (Historical/Superseded), HISTORICAL / SUPERSEDED

### Community 73 - "Metrics Relationships"
Cohesion: 0.25
...
### Community 74 - "Proxy Edge Rendering"
Cohesion: 0.25
...
### Community 75 - "View Capability Management"
Cohesion: 0.29
...
### Community 77 - "Configuration Hashing"
Cohesion: 0.29
...
### Community 78 - "Depth Ordering Architecture"
Cohesion: 0.33
...
### Community 79 - "Metrics Manifest Testing"
Cohesion: 0.60
...
### Community 80 - "Raster Decomposition Testing"
Cohesion: 0.47
...
### Community 81 - "Cache Signature Verification"
Cohesion: 0.33
...
### Community 82 - "NumPy and Pillow Integration"
Cohesion: 0.33
...
### Community 83 - "Development Tasks"
Cohesion: 0.40
...
### Community 84 - "Occupancy Channel Testing"
Cohesion: 0.70
...
### Community 94 - "Tile Depth Conflict Checking"
Cohesion: 0.50
...
### Community 95 - "Cache Key Generation"
Cohesion: 0.50
...
### Community 100 - "Campaign Code Mapping"
Cohesion: 1.00
...
## Knowledge Gaps
- **273 isolated node(s):** `App`, `Annotation Type Classification (7 Types: TEXT/TAG/DIM/DETAIL/LINES/REGION/OTHER)`, `Golden Baseline Regression Testing`, `LRU Element Cache with Fingerprint Keying`, `Streaming Pipeline (Memory-Aware Per-View Export)` (+268 more)
...
- **Why does `Config` connect `Module Import Tests` to `Mutation Analysis Tools`, `External Source Probing`, `Image Alignment Probing`, `Configuration Hash Tests`, `Final State Scanning`, `Streaming Pipeline Processing`, `Graphics Semantics Probing`, `Geometry Extraction Utilities`, `Phase Validation Tests`, `Pipeline Diagnostics Testing`, `View Raster Testing`, `Phase 7 CSV Export Tests`, `Geometry Classification Tests`, `UV Classification Testing`, `Resolution Management Utilities`, `Front Face Strategy Testing`, `Proxy Generation Testing`, `TileMap Testing`, `View Resolution Management`, `Metrics Manifest Testing`?**
  _High betweenness centrality (0.221) - this node is a cross-community bridge._
- **Why does `MemoryTracker` connect `Memory Telemetry Utilities` to `Mock Object Definitions`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `Files` connect `Core Utilities` to `VOP Interwoven Code Map`, `Memory Telemetry Utilities`?**
...
- **What connects `App`, `Annotation Type Classification (7 Types: TEXT/TAG/DIM/DETAIL/LINES/REGION/OTHER)`, `Golden Baseline Regression Testing` to the rest of the system?**
  _273 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Mock Object Definitions` be split into smaller, more focused modules?**
