...
Probe `stage_a_anno_pass_variants` version 2026-09-22.4; combined report `C:\Users\gmcdowell\Documents\VOP\Exports\FVoT\probe_0923_0827\anno_pass_variants_probe\__Elevation_CropActive_19293413.anno_pass_variants.json`.
...
- **white-suppression cost**: 21471 ms for 6536 element override(s), against 25976 ms for the whole model pass (ratio 0.83; a LOWER bound on suppression-vs-paint, since production does not time its paint alone)
  - by mechanism (ms): category_override_writes 21290, element_overrides 92, category_override_reads 31, category_collect 8, build_override 4, subcategory_walk 4, link_category_filters 0
  ...
  - `v0_control`: pre-state commit 2 ms; restore blank writes -- ms, category/link reverse -- ms, restore commit 3 ms
  - `v7_no_crop`: pre-state commit 2170 ms; restore blank writes 72 ms, category/link reverse 33177 ms, restore commit 1793 ms
  - `v8_no_crop_fiducials`: pre-state commit 1622 ms; restore blank writes 54 ms, category/link reverse 34910 ms, restore commit 1767 ms
...
Probe `stage_a_anno_pass_variants` version 2026-09-22.4; combined report `C:\Users\gmcdowell\Documents\VOP\Exports\FVoT\probe_0923_0827\anno_pass_variants_probe\__Plan_CropActive_19290402.anno_pass_variants.json`.
...
- crop shape: 1 loop(s), 4 edge(s), rectangle: yes, oblique edges: 0
- **white-suppression cost**: 26594 ms for 4784 element override(s), against 23790 ms for the whole model pass (ratio 1.12; a LOWER bound on suppression-vs-paint, since production does not time its paint alone)
  - by mechanism (ms): category_override_writes 26462, element_overrides 65, category_override_reads 14, category_collect 7, build_override 2, subcategory_walk 1, link_category_filters 0
  ...
  - `v0_control`: pre-state commit 2 ms; restore blank writes -- ms, category/link reverse -- ms, restore commit 3 ms
  - `v7_no_crop`: pre-state commit 3704 ms; restore blank writes 43 ms, category/link reverse 48996 ms, restore commit 3359 ms
  - `v8_no_crop_fiducials`: pre-state commit 3361 ms; restore blank writes 54 ms, category/link reverse 50820 ms, restore commit 3300 ms
...
| v7_no_crop | 269 pairs | 16.337 | 16.871 | 18.754 | (290.8, 329.5) | 19.24 / 192.94 | negative (expected) |
| v8_no_crop_fiducials | 269 pairs | 16.337 | 16.871 | 18.754 | (290.8, 329.5) | 19.24 / 192.94 | negative (expected) |
...
| v7_no_crop | 16.289 | 16.319 | 0.0478 | 0.5518 | -0.345 / -0.520 / -2.307 / -1.810 |  |
| v8_no_crop_fiducials | 16.289 | 16.319 | 0.0478 | 0.5518 | -0.345 / -0.520 / -2.307 / -1.810 |  |
...
| Room Tags | 17 | 0.993 (0.961 .. 1.010) | 0.872 (0.872 .. 0.910) | 0.201 (0.125 .. 0.218) | 0.4 (0.0 .. 2.1) | 3.5 (3.0 .. 3.7) |
| Views | 3 | 0.993 (0.990 .. 0.999) | 0.968 (0.963 .. 0.972) | 0.018 (0.016 .. 0.020) | 1.6 (0.3 .. 1.7) | 4.3 (3.6 .. 4.4) |
...
| v7_no_crop | 9898226 | 9664755 | 198964 | 34507 | 0.00349 | 33845 | 660 | 2 | 1388 | no |
| v8_no_crop_fiducials | 9898226 | 9664275 | 198964 | 34507 | 0.00349 | 33845 | 660 | 2 | 1388 | no |
...
- `v8_no_crop_fiducials` fiducial 12261162: 463 px in the annotation capture, None px in the model capture
...
| v8_no_crop_fiducials | F1_vs_F2 | -- | -- | -- | one of the two mappings is not available |
| v8_no_crop_fiducials | F1_vs_bbox_fit | -- | -- | -- | one of the two mappings is not available |
| v8_no_crop_fiducials | F2_vs_bbox_fit | -0.0725 | -0.4869 | 22.69 |  |
...
| v7_no_crop | external | 34507 | 0 | 0 | 34507 |
| v8_no_crop_fiducials | external | 34507 | 480 | 0 | 34507 |
